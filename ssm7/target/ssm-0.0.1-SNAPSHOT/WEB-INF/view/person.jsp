...
<body class="gray-bg">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>人员特点：</td>
								<td><input type="checkbox" id="expressTrait1" name="expressTrait"
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_import" method="post" action="importPerson.htm" enctype="multipart/form-date">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>请选择导入文件：</td>
								<td><input type="file" id="persontFile" name="personFile"
									class="form-control" aria-required="true" required/></td>
								<td>&nbsp;&nbsp;</td>
						</tr>
